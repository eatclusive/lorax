...
const char* ssid = "fazenrazen";         // Replace with your WiFi SSID
const char* password = "iloveMyself"; // Replace with your WiFi Password
const char* mqtt_server = "127.0.0.1"; // IP address of your MQTT broker
